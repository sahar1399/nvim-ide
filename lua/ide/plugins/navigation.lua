...
return {
  ...
  },
  {
    ...
    lazy = true,
    keys = {
      { "gh",         "<cmd>Lspsaga lsp_finder<CR>",      "n", desc = "Find Usage & Definitions" },
      { "<leader>rr", "<cmd>Lspsaga rename<CR>",          "n", desc = "Rename" },
      { "gP",         "<cmd>Lspsaga peek_definition<CR>", "n", desc = "Peek Definition" },
      { "<C-s>",      "<cmd>Lspsaga outline<CR>",         "n", desc = "Show Symbols Outline" },
      { "<leader>ci", "<cmd>Lspsaga incoming_calls<CR>",  "n", desc = "Show References" },
      { "<leader>co", "<cmd>Lspsaga outgoing_calls<CR>",  "n", desc = "Show De-References" },
    },
    branch = "main",
    config = function()
